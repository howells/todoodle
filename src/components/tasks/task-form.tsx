...
import type { RecurrencePattern, TaskAssignment, TaskCategory } from "@/types";
...
export function TaskForm({
	...
	const [assignAll, setAssignAll] = useState(
		initialData?.assignment.type === "all" || !initialData?.assignment,
	);
		...
		<form onSubmit={handleSubmit} className="space-y-6 max-w-lg">
			...
			<div>
				...
				{recurrenceType === "weekly" && (
					<div className="mt-3">
						<p className="text-sm text-muted-foreground mb-2">Which days?</p>
